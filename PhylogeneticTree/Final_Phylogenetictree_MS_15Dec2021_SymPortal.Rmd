---
title: "SymPortal final phylogenetic tree - MS biogeo 1 Nov 2021"
output: pdf_document
---
...
```{r}
taxtable<-read.csv("/Users/victoriamarieglynn/Desktop/Desktop_May2021/CC_11May2021_DINOenv/SymPortaltaxa_Poc_DINO_Sep2020.csv")
summary(taxtable)
...
itst_tree_colors <- itst_tree + scale_color_manual(values=c("#CC3300", "#FF9900", "#66CC33", "#33CC00", "#99FF00","#9966CC","#CC99FF", "#CC99CC", "#FFCCFF", "#FF00FF"))

itst_tree_colors

ggsave("Phylotree_SYMPORTAL_ITSclade_10Dec2021.pdf")
